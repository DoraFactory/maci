...
**Pre-add-new-key** combines anonymity and speed. Deactivate tree is pre-configured when voting round is created, users can register anonymously immediately.
