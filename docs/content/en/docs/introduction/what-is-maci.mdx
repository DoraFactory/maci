...
**Add-new-key** is fully anonymous. Create a new identity through zero-knowledge proofs; the operator cannot link it to your original address. Requires waiting for the operator to process deactivate messages.
