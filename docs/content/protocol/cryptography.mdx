...
MACI 使用多种密码学原语来实现隐私保护和安全性。本节详细介绍这些密码学机制的工作原理。
...
现在您已经了解了 MACI 的密码学机制，接下来可以学习：

- 📨 [消息流程](/protocol/message-flow) - 了解消息如何在系统中流动
- 🛡️ [隐私保护](/protocol/privacy-protection) - 探索隐私保护的实现细节
- 🏗️ [合约设计](/contracts/architecture) - 了解合约如何使用这些密码学原语
