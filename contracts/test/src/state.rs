...
// Independent storage for no-hash testing
pub const NUMSIGNUPS_NO_HASH: Item<Uint256> = Item::new("num_sign_ups_no_hash");
pub const NODES_NO_HASH: Map<Vec<u8>, Uint256> = Map::new("nodes_no_hash");
